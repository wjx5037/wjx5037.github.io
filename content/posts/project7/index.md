...
Airport Cooperative Research Program (ACRP) project, advised by Dr. Denise Turso, where our team designed LuggageLocator, an RFID-based end-to-end baggage-visibility system to reduce mishandled luggage and improve passenger experience. The solution combines a U-shaped RFID scanning station with a data dashboard and database backend for real-time baggage status and bottleneck insights. My contribution focused on problem framing and literature review, decision-matrix concept evaluation, CAD modeling and structural analysis of the RFID scanner, and RFID hardware feasibility and testing. The website/dashboard and database prototype were designed and implemented by a teammate.
...
**My contribution:** problem framing and literature review, decision-matrix concept selection, U-shaped RFID scanner CAD modeling and structural analysis, and RFID hardware feasibility and testing. **A teammate designed and implemented the website/dashboard and database prototype.**
